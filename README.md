...
A FAL can be for example used by operators or producers for due diligence purposes relating to the [Regulation on Deforestation-free Products](https://environment.ec.europa.eu/topics/forests/deforestation/regulation-deforestation-free-products_en) **(EUDR)**, to monitor compliance with deforestation-free requirements, as it refers to the cut-off year and the definitions set out in the regulation. 
...
---
<span style="color:blue;"> **Note:** Both scripts are designed to be modular and user-friendly, allowing you to reproduce analyses over custom regions of interest (ROIs) or polygons/points with minimal setup requirements.</span>
---
