...
FAL can be for example used by producers or operators in the frame of the EUDR for due dilligence purposes or deforestation-free compliance monitoring. The provided GEE scripts are open access (see for licence type details below). 
