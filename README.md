...
A FAL can be for example used by operators or producers for due diligence purposes relating to the [Regulation on Deforestation-free Products](https://environment.ec.europa.eu/topics/forests/deforestation/regulation-deforestation-free-products_en) **(EUDR)** as it refers to the cut-off year and the definitions set out in the regulation. It can also used to monitor compliance with deforestation-free requirements beyond the scope of the regulation or for completely other purposes as defined by a user.
