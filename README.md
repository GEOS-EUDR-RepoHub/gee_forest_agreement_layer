...
One script generates the FAL for a predefined region of interest (ROI), while the other builds it directly from geodata inputs such as plot boundaries uploaded by a user.
